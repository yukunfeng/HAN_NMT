...
# han_joint_exact_name="./saved_models/zh_en_ted.joint_acc_40.81_ppl_36.23_e22.pt"
...
# sent_exact_model=$(ls ./saved_models/*e22.pt)
# translate_models=($sent_exact_model)
translate_models=( ./saved_models/zh_en_ted.sent_acc_41.24_ppl_28.77_e20.pt ./saved_models/zh_en_ted.sent_acc_41.33_ppl_29.83_e21.pt ./saved_models/zh_en_ted.sent_acc_41.30_ppl_31.04_e22.pt ./saved_models/zh_en_ted.sent_acc_41.25_ppl_32.77_e23.pt ./saved_models/zh_en_ted.sent_acc_40.82_ppl_34.67_e24.pt ./saved_models/zh_en_ted.sent_acc_40.88_ppl_35.81_e25.pt ./saved_models/zh_en_ted.sent_acc_40.24_ppl_38.39_e26.pt  )
for translate_model in "${translate_models[@]}"
do
    translate_out="$(basename $translate_tgt).by.$(basename $translate_model).txt"
    python ./full_source/translate.py -model $translate_model \
